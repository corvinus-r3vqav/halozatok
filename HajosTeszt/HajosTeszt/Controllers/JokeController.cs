...
namespace HajosTeszt.Controllers
{
    ...
    public class JokeController : ControllerBase
    {
        // GET: api/jokes
        [HttpGet]
        public IEnumerable<Joke> Get()//osszes vicc lekerdezese
        {
        ...
        // GET api/jokes/5
        [HttpGet("{id}")]
        public Joke Get(int id)//egy adott vicc lekerdezese
        {
            FunnyDatabaseContext context = new FunnyDatabaseContext();
        ...
        // POST api/jokes
        [HttpPost]
        public void Post([FromBody] Joke újVicc)//uj vicc rogzitese
        {
            FunnyDatabaseContext context = new FunnyDatabaseContext();
        ...
        // DELETE api/jokes/5
        [HttpDelete("{id}")]
        public void Delete(int id)//adott sorszamu vicc torlese
        {
            FunnyDatabaseContext context = new FunnyDatabaseContext();
